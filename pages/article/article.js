...
Page({
    ...
    onShow: function () {
        ...
        // });
        wx.request({
            url:'https://sparrowoo.top:8234/Articles/Read?article_id='+this.post_id,
            method:'GET',
            header: {
            ...
            success (res) {
                  console.log(res);
                    ...
                    WxParse.wxParse('article', 'html', res.data.results.article_content, that, 5);
    ...
    handlerLikeClick: function (e) {
        ...
        // })
        wx.request({
            url:"https://sparrowoo.top:8234/Articles/Like?article_id="+this.post_id+"&post_like="+that.data.post_like,
            method:"GET",
            header:{
                'content-type': "application/json",
            ...
            success(res){
                console.log(res)
                console.log(that.data.post_like)
                that.setData({
                    post_like: (that.data.post_like == 1 ? 0 : 1),
                });
            }
    ...
    handlerCommentSubmit: function (e) {
        ...
        wx.request({
            url:'https://sparrowoo.top:8234/Articles/PostComment',
            method:'POST',
            header:{
